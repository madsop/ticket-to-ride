...
public final class Nordic extends AbstractSpelUtgaave implements ISpelUtgaave {
	...
	protected ArrayList<IOppdrag> fyllMedOppdrag() {
		...
		int oppdragsid = 0;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Oslo,Destinasjon.MoIRana,10));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Bergen,Destinasjon.København,9));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Narvik,Destinasjon.Tallinn,13));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Helsinki,Destinasjon.Lieksa,5));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Aalborg,Destinasjon.Norrkøping,5));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Helsinki,Destinasjon.København,10));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Helsinki,Destinasjon.Bergen,12));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Helsinki,Destinasjon.Østersund,8));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Bergen,Destinasjon.Trondheim,7));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Ørebro,Destinasjon.Kuopio,10));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Stockholm,Destinasjon.Bergen,8));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Turku,Destinasjon.Trondheim,10));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Stavanger,Destinasjon.Karlskrona,8));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Oslo,Destinasjon.Vaasa,9));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Oslo,Destinasjon.Stavanger,4));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Sundsvall,Destinasjon.Lahti,6));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Kristiansand,Destinasjon.MoIRana,12));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Stockholm,Destinasjon.Kajaani,10));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Oslo,Destinasjon.Stockholm,4));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Gøteborg,Destinasjon.Oulo,12));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Helsinki,Destinasjon.Kiruna,10));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Tornio,Destinasjon.Imatra,6));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.København,Destinasjon.Oulo,14));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Tampere,Destinasjon.Tallinn,3));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Tromsø,Destinasjon.Vaasa,11));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Narvik,Destinasjon.Murmansk,12));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Stockholm,Destinasjon.Imatra,7));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Gøteborg,Destinasjon.Turku,7));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Tampere,Destinasjon.Boden,6));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Aalborg,Destinasjon.Umeå,11));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Oslo,Destinasjon.Helsinki,8));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Helsinki,Destinasjon.Kirkenes,13));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Gøteborg,Destinasjon.Åndalsnes,6));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Stockholm,Destinasjon.Umeå,7));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Århus,Destinasjon.Lillehammer,6));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Stockholm,Destinasjon.København,6));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Norrkøping,Destinasjon.Boden,11));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Tampere,Destinasjon.Kristiansand,10));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Oslo,Destinasjon.Honningsvåg,21));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Bergen,Destinasjon.Tornio,17));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Bergen,Destinasjon.Narvik,16));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Stockholm,Destinasjon.Tromsø,17));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.København,Destinasjon.Murmansk,24));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.Stavanger,Destinasjon.Rovaniemi,18));
		oppdragsid++;
		IOppdrag.add(new Oppdrag(oppdragsid,Destinasjon.København,Destinasjon.Narvik,18));
		return IOppdrag;
	}
}